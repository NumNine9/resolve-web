...
import { getAllItems, useQuery } from 'wasp/client/operations'

function MarketPage() {
    const { data: allItems, error: error1 } = useQuery(getAllItems)
    console.log('these are all items:------------', allItems?.length, error1)
    if (error1 !== null ) {
            ...
            <div>
                ...
                <ol className="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                    ...
                    <div className="flex items-center">
                        ...
                        <a href="#" className="ms-1 text-sm font-medium text-gray-700 hover:text-primary-600 dark:text-gray-400 dark:hover:text-white md:ms-2">Marketplace</a>
                    </div>
                    </li>
                    ...
                    <div className="flex items-center">
                        ...
                        <span className="ms-1 text-sm font-medium text-gray-500 dark:text-gray-400 md:ms-2">Products</span>
                    </div>
                    </li>
                </ol>
                </nav>
            ...
            {allItems ? 
                ...
                <div key={index} className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
                        ...
                        <div className="mt-4 flex items-center justify-between gap-4">
                            <p className="text-2xl font-extrabold leading-tight text-gray-900 dark:text-black">€{item.price}</p>
